...
<html lang="en">
  ...
  <body>
	...
	<script>
		...
		function AproveDataMissing() {
			$.ajax({
				url: "get_aproved_missing.php",
				type: "GET",
				success: function(data) {
					...
					$.each(jsonData, function(index, item) {
						var row = "<tr>" +
							...
							// "<td><button class='edit-btn btn btn-primary' data-id='" + jsonData[index].employee_id + "'>Aprove</button></td>" +
							"</tr>";
        ...
        function AproveDataWanted() {
			$.ajax({
				url: "get_aproved_wanted.php",
				type: "GET",
				success: function(data) {
					// Clear the table body
					$("#data-table tbody").empty();
