  ...
  <body>
    ...
    <div class="container">
        ...
        <ul class="navbar-nav">
            ...
            <a class="nav-link" href="#">Wating</a>
            </li>
            <li class="nav-item">
    ...
    <form action=""> 
    <select name="select" onchange="showall(this.value)">
	...
	<script>
		...
		function updateDataMissing() {
			$.ajax({
				url: "get_data_missing_waiting.php",
				type: "GET",
				success: function(data) {
					...
					$.each(jsonData, function(index, item) {
						var row = "<tr>" +
							...
							// "<td>" + jsonData[index].last_name + "</td>" +
							"<td><button class='edit-btn btn btn-primary' data-id='" + jsonData[index].id + "'>Aprove</button></td>" +
							"</tr>";
		...
		function updateRowMissing(id) {
			// Send an AJAX request to update the row in the database
			$.ajax({
				url: "update_row_missing_waiting.php",
				type: "POST",
				data: {
					id: id
				},
				success: function(data) {
					//console.log(data);
					// If the update was successful, update the table on the page
					if (data == "success") {
						updateDataMissing();
						//console.log('ok');
					}
        ...
        function updateDataWanted() {
			$.ajax({
				url: "get_data_wanted_waiting.php",
				type: "GET",
				success: function(data) {
					// Clear the table body
					$("#data-table tbody").empty();
		...
		function updateRowWanted(id) {
			// Send an AJAX request to update the row in the database
			$.ajax({
				url: "update_row_wanted_waiting.php",
				type: "POST",
				data: {
					id: id
				},
